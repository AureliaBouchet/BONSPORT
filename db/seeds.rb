...
playground_thirteen.user = User.last
...
playground_fourteen.user = User.last
...
playground_fifteen.user = User.last
...
playground_sixteen.user = User.last
...
playground_seventeen.user = User.last
...
playground_eighteen.user = User.last
